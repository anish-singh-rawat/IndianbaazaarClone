  ...
  settings: [
    {
      ...
      site: {
        name: 'Indian Baazaar',
        description:
          'Indian Baazaar is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'Next Ecommerce, Next.js, Tailwind CSS, MongoDB',
        url: 'https://next-mongo-ecommerce-final.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Indian Baazaar, Next Ecommerce',
        copyright: '2000-2024, indianbaazaar.com, Inc. or its affiliates',
        email: 'admin@example.com',
      ...
      availableCurrencies: [
        ...
        { name: 'Indian Rupee', code: 'INR', symbol: '₹', convertRate: 83.10 },
      ],
      defaultCurrency: 'USD',
